...
// ResetLLMProfileAPIKeys resets all LLM profile API keys to empty strings
// This is a utility function for fixing encryption issues
func ResetLLMProfileAPIKeys() {
